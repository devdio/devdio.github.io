...
class ExtensionWorker {
    ...
    dispatch.waitForConnection.then(() => {
      dispatch.call('extensions', 'allocateWorker').then(x => {
        ...
        try {
          ...
          var initialRegistrations = this.initialRegistrations;
  ...
  register(extensionObject) {
    ...
    var promise = dispatch.setService(serviceName, extensionObject).then(() => dispatch.call('extensions', 'registerExtensionService', serviceName));
...
class SharedDispatch {
  ...
  _remoteTransferCall(provider, service, method, transfer) {
    ...
    return new Promise((resolve, reject) => {
      var responseId = this._storeCallbacks(resolve, reject);
  ...
  _deliverResponse(responseId, message) {
    try {
      var [resolve, reject] = this.callbacks[responseId];
