...
var appTarget = document.createElement('div'); // ks.moon

appTarget.setAttribute('id', 'scratch-root-div');
...
if (Object(_lib_supported_browser__WEBPACK_IMPORTED_MODULE_8__["default"])()) {
  console.log('{playground/index.jsx}', '*** supportedBrowser'); // require needed here to avoid importing unsupported browser-crashing code
  // at the top level

  __webpack_require__(/*! ./render-gui.jsx */ "./src/playground/render-gui.jsx").default(appTarget);
} else {
  console.log('{playground/index.jsx}', '*** NOT *** supportedBrowser');
  ...
  var handleBack = () => {}; // eslint-disable-next-line react/jsx-no-bind
